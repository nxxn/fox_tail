...
ActiveRecord::Schema.define(version: 20161113233134) do
  ...
  add_index "spree_store_translations", ["spree_store_id"], name: "index_spree_store_translations_on_spree_store_id"
